...
func (m model) helpText() string {
	return strings.Join([]string{
		...
		"- `/add model`: open the setup flow to add or configure a provider/model.",
		"- `/delete model`: open the configured model picker and delete one target.",
		"- `/models`: show configured providers and discovered models.",
		"- `/model picker`: open the model picker and switch the active model with Up/Down + Enter.",
